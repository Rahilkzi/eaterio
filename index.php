...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to FOODBREAK</h1>
                        ...
                        <div class="card rounded-25 mb-4 category-card" data-category="<?php echo $type_id; ?>"
                            ...
                            <div class="card-img-top">
                                ...
                                ?> style="width:100%; height:150px; object-fit:cover;" class="img-fluid"
                                    alt="<?php echo $type_row["f_type"] ? $type_row["f_type"] : 'All items'; ?>">
                            </div>
                            <div class="card-body text-center">
                                <h5 class="card-title fs-5">
                                    <?php echo (empty($type_row["f_type"]) || $type_row["f_type"] == "null") ? "All items" : $type_row["f_type"]; ?>
                                </h5>
