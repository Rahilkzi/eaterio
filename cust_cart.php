        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            ...
            <div class="col mt-3 mt-md-0">
                <div class="row row-cols-1">
                    ...
                    <form method="POST" action="add_order.php" id="order_form">
                        <div class="col mb-1">
                        ...
                        <div class="col">
                            ...
                            <?php }else{ ?>
                            <button type="button" class="w-100 btn btn-primary" onclick="initiatePayment()">
...
<!-- Replace Omise script with Razorpay script -->
<script src="https://checkout.razorpay.com/v1/checkout.js"></script>
<script>
function initiatePayment() {
    var options = {
        "key": "rzp_test_gLaC5NWMEHiGpN", // Replace with your Razorpay test key
        "amount": <?php echo $order_cost*100;?>,
        "currency": "INR",
        "name": "EATERIO",
        "description": "Food Order Payment",
        "image": "img/ICON_F.png",
        "handler": function (response){
            // Add hidden input fields with payment details
            document.getElementById('razorpay_payment_id').value = response.razorpay_payment_id;
            document.getElementById('order_form').submit();
        },
        "prefill": {
            "name": "<?php echo $_SESSION["firstname"]." ".$_SESSION["lastname"]; ?>",
            "email": "<?php echo $cust_arr["c_email"]?>"
        },
        "theme": {
            "color": "#0d6efd"
        }
